...
<script type="text/javascript">
    ...
    })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=110154669', 'ym');

    ym(110154669, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", referrer: document.referrer, url: location.href, accurateTrackBounce:true, trackLinks:true});
</script>
<noscript><div><img src="https://mc.yandex.ru/watch/110154669" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
</head>
<body>
<header class="navbar">
...
<footer class="footer">
  <div class="shell footer__inner">
    <div>
      ...
      <p class="footer__soft">Просветительский проект <a href="https://zelenykh.ru" target="_blank" rel="noopener">Зеленых Дениса</a> о тёмных приёмах в дизайне интерфейсов. Материалы не являются юридической консультацией. Под редакцией <a href="https://t.me/+cplTLI9cw1xmNTAy" target="_blank" rel="noopener">Lorrrem</a>.</p>
