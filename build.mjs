...
<section class="hero">
  <div class="shell">
    <div class="hero__banner">
      ...
      <p class="hero__lead">Эти паттерны — не просто «неудобный дизайн». Это намеренно выстроенные ловушки в сайтах и приложениях, которые используют психологию против вас.</p>
      <div class="hero__cta">
